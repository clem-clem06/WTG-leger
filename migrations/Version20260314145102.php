 ...
 */
final class Version20260314145102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE unite ADD date_fin_location DATETIME DEFAULT NULL, ADD locataire_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_1D64C118D8A38199 ON unite (locataire_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_1D64C118D8A38199 ON unite');
        $this->addSql('ALTER TABLE unite DROP date_fin_location, DROP locataire_id');
    }
}
