 ...
 */
final class Version20260314162342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item ADD duree_mois INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE order_item ADD duree_mois INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item DROP duree_mois');
        ...
        $this->addSql('ALTER TABLE order_item DROP duree_mois');
